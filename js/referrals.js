...
"https://script.google.com/macros/s/AKfycbwl_YFz58K6Cu1238_fbS4UoQkp5JIhpq9x7
lLhWw0jdibnjf-obpgb-V9MPtuK7fg/exec";
// ======================================================
// Modals
// ======================================================
...
"ar"
 ...
 `<option value="">الطبيب اختر>/option>`;
 allDoctors.forEach(
 doctor => {
 const option =
...
addCbctTooth.checked
 ...
 alert(
 " لـ األقل على واحد سن اختيار يرجىCBCT Tooth"
 );
 return;
 }
 }
...
this.checked
 ...
 const ok =
 confirm(
 "\اإلحالة؟ هذه حذف من متأكد أنت هلn\n" +
 " من حذفها سيتمFirebase وGoogle Sheet."
 );
 if (!ok) {
 return;
 }
 ...
 GOOGLE_SCRIPT_URL,
{
 ...
 " من حذفها يتم لم لكنGoogle Sheet."
 );
 return;
 }
 alert(
